...
public class CreateShapeCommand implements ICommand, IUndoable {
	...
	public CreateShapeCommand(Point p1, Point p2, PaintCanvasBase paintCanvas, Color primaryColor, Color secondaryColor, ShapeShadingType sst, ApplicationState appState, ShapeList shapeList) {
		this.p1 = p1;
		this.p2 = p2;
	...
	@Override
	public void run() {
		shape = new CreateShapeCommand(p1, p2, paintCanvas, primaryColor, secondaryColor, sst, appState, shapeList);
