...
public class MoveShapeCommand implements ICommand, IUndoable, ISelectedShapesList {
    ...
    private final LinkedList<CreateShapeCommand> tempMoveList;
    private final LinkedList<CreateShapeCommand> tempRemoveList;
    ...
    public void run() {
        ...
        for (CreateShapeCommand selectedShape : selectedShapes) {
            for (CreateShapeCommand drawnShape : shapeList.getList()) {
        ...
        for (CreateShapeCommand temp1 : tempRemoveList) {
            selectedShapes.remove(temp1);
            shapeList.removeShape(temp1);
        }
        for (CreateShapeCommand temp1 : tempMoveList) {
